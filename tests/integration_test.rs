...
fn test_polynomial_of_natural_numbers() {
    ...
    assert_eq!(const_polynom, Polynomial::from_vector(vec![NaturalNumber::new(5)]));

    let p = x_pow_3.clone() + x.clone() * NaturalNumber::new(2) + const_polynom.clone();
    assert_eq!(p, Polynomial::from_vector(vec![NaturalNumber::new(5), NaturalNumber::new(2), NaturalNumber::new(0), NaturalNumber::new(1)]));
...
fn test_polynomial_of_matrices() {
    let p = Polynomial::from_vector(vec![
        SquareMatrix::new([[NaturalNumber::new(1), NaturalNumber::new(2)], [NaturalNumber::new(3), NaturalNumber::new(4)]]),
        SquareMatrix::new([[NaturalNumber::new(5), NaturalNumber::new(6)], [NaturalNumber::new(7), NaturalNumber::new(8)]]),
        SquareMatrix::new([[NaturalNumber::new(9), NaturalNumber::new(10)], [NaturalNumber::new(11), NaturalNumber::new(12)]]),
        SquareMatrix::new([[NaturalNumber::new(0), NaturalNumber::new(0)], [NaturalNumber::new(0), NaturalNumber::new(0)]])
    ]);
    assert_eq!(p, Polynomial::from_vector(vec![
        SquareMatrix::new([[NaturalNumber::new(1), NaturalNumber::new(2)], [NaturalNumber::new(3), NaturalNumber::new(4)]]),
        SquareMatrix::new([[NaturalNumber::new(5), NaturalNumber::new(6)], [NaturalNumber::new(7), NaturalNumber::new(8)]]),
        SquareMatrix::new([[NaturalNumber::new(9), NaturalNumber::new(10)], [NaturalNumber::new(11), NaturalNumber::new(12)]])
    ]));
    ...
    assert_eq!(x, Polynomial::from_vector(vec![
        SquareMatrix::new([[NaturalNumber::new(0), NaturalNumber::new(0)], [NaturalNumber::new(0), NaturalNumber::new(0)]]),
        SquareMatrix::new([[NaturalNumber::new(1), NaturalNumber::new(0)], [NaturalNumber::new(0), NaturalNumber::new(1)]])
    ]));

    let x_pow_3 = Polynomial::<SquareMatrix<NaturalNumber, 2>>::x_pow(3);
    assert_eq!(x_pow_3, Polynomial::from_vector(vec![
        SquareMatrix::new([[NaturalNumber::new(0), NaturalNumber::new(0)], [NaturalNumber::new(0), NaturalNumber::new(0)]]),
        SquareMatrix::new([[NaturalNumber::new(0), NaturalNumber::new(0)], [NaturalNumber::new(0), NaturalNumber::new(0)]]),
        SquareMatrix::new([[NaturalNumber::new(0), NaturalNumber::new(0)], [NaturalNumber::new(0), NaturalNumber::new(0)]]),
        SquareMatrix::new([[NaturalNumber::new(1), NaturalNumber::new(0)], [NaturalNumber::new(0), NaturalNumber::new(1)]])
    ...
    let const_polynom = Polynomial::<SquareMatrix<NaturalNumber, 2>>::from_constant(SquareMatrix::new([[NaturalNumber::new(5), NaturalNumber::new(6)], [NaturalNumber::new(7), NaturalNumber::new(8)]]));
    assert_eq!(const_polynom, Polynomial::from_vector(vec![SquareMatrix::new([[NaturalNumber::new(5), NaturalNumber::new(6)], [NaturalNumber::new(7), NaturalNumber::new(8)]])]));
}
